...
const EditTask = () => {
 ...
 (   <div className='lg:hidden w-full bg-[#0d0d0d65] backdrop-blur-sm absolute h-screen z-50 top-0 flex flex-col justify-between transition-all ease-in-out ml-[-17px]'>
        ...
        <div className='w-full pt-[15px] pb-[20px]'>
            ...
            <h5 className='text-[14px] font-bold'>Create Wireframe</h5>
            ...
            <div className="w-full mt-[15px] flex justify-between items-center">
                <button className="border-[#3F5BF6] text-[#3F5BF6] border-[1px] h-[35px] w-[47%] text-[13px] font-bold">Delete</button>
                <button className="bg-[#3F5BF6] h-[35px] w-[47%] text-white text-[13px] font-bold cursor-pointer hover:bg-[#0E31F2]">Edit</button>
            </div>
